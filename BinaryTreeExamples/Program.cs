...
namespace BinaryTreeExamples
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            BinNode<char> tree = new BinNode<char>('a');
            BinNode<char> charleft = new BinNode<char>(new BinNode<char>('b'), 'c', new BinNode<char>('d'));
            BinNode<char> charRight = new BinNode<char>('z');
            tree.SetLeft(charleft);
            tree.SetRight(charRight);
            Console.WriteLine(tree);
            BTHelper.UpdateCharTree(tree);
            Console.WriteLine(tree);
